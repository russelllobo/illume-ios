...
export const getExternalPurchaseCustomLinkTokenIOS = async (tokenType) => {
    if (!tokenType) {
        throw new Error("getExternalPurchaseCustomLinkTokenIOS requires a tokenType ('acquisition' or 'services')");
    }
...
export const showExternalPurchaseCustomLinkNoticeIOS = async (noticeType) => {
    if (!noticeType) {
        throw new Error("showExternalPurchaseCustomLinkNoticeIOS requires a noticeType ('browser')");
    }
    const result = await ExpoIapModule.showExternalPurchaseCustomLinkNoticeIOS(noticeType);
    return result;
};
