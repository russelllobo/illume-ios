...
<head>
    <title>Code coverage report for src/utils/errorMapping.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> errorMapping.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  return createPurchaseError({
    message: errorData.message ?? <span class="branch-1 cbranch-no" title="branch not covered" >'Unknown error occurred',</span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >          'An unexpected error occurred'</span>
        );
      }
