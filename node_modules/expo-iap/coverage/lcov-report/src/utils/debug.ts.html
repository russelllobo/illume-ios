...
<head>
    <title>Code coverage report for src/utils/debug.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> debug.ts</h1>
        <div class='clearfix'>
...
&nbsp;
const createConsole = () =&gt; ({
  log: <span class="fstat-no" title="function not covered" >(.</span>..args: any[]) =&gt; {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (isLibraryDevelopment()) {</span>
<span class="cstat-no" title="statement not covered" >      console.log('[Expo-IAP]', ...args);</span>
    }
    // Silent for library users
  },
&nbsp;
  debug: (...args: any[]) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isLibraryDevelopment()) {
<span class="cstat-no" title="statement not covered" >      console.debug('[Expo-IAP Debug]', ...args);</span>
    }
    // Silent for library users
  },
&nbsp;
...
&nbsp;
  info: <span class="fstat-no" title="function not covered" >(.</span>..args: any[]) =&gt; {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (isLibraryDevelopment()) {</span>
<span class="cstat-no" title="statement not covered" >      console.info('[Expo-IAP]', ...args);</span>
    }
    // Silent for library users
  },
});
