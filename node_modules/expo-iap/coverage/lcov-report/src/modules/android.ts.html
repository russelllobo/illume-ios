...
<head>
    <title>Code coverage report for src/modules/android.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/modules</a> android.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  const url = sku ? `${base}&amp;sku=${encodeURIComponent(sku)}` : <span class="branch-1 cbranch-no" title="branch not covered" >base;</span>
...
<span class="cstat-no" title="statement not covered" >  return ExpoIapModule.checkAlternativeBillingAvailabilityAndroid();</span>
};
&nbsp;
/**
...
&gt; = <span class="fstat-no" title="function not covered" >async </span>() =&gt; {
<span class="cstat-no" title="statement not covered" >  return ExpoIapModule.showAlternativeBillingDialogAndroid();</span>
};
&nbsp;
/**
...
&gt; = <span class="fstat-no" title="function not covered" >async </span>(sku?: string) =&gt; {
<span class="cstat-no" title="statement not covered" >  return ExpoIapModule.createAlternativeBillingTokenAndroid(sku);</span>
};
&nbsp;
// ============================================================================
