    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>232/241</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>109/118</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>216/224</span>
            </div>
...
<a name='L925'></a><a href='#L925'>925</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="fstat-no" title="function not covered" >  removeListener(</span>eventName, listener) {
<span class="cstat-no" title="statement not covered" >    return getNativeModule().removeListener(eventName, listener);</span>
  },
};
&nbsp;
/**
...
&nbsp;
  ...
  if (lowered === platform || (lowered !== 'ios' &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >lowered !== 'android')</span>) {
    return purchase;
  }
&nbsp;
...
export const promotedProductListenerIOS = (
  ...
  if (Platform.OS !== 'ios') {
    ...
    return {remove: <span class="fstat-no" title="function not covered" >() =</span>&gt; {}};
  }
...
export const fetchProducts: QueryField&lt;'fetchProducts'&gt; = async (request) =&gt; {
  ...
  const {skus, type} = request ?? <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
...
export const getStorefront: QueryField&lt;'getStorefront'&gt; = async () =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (Platform.OS !== 'ios' &amp;&amp; Platform.OS !== 'android') {
...
&nbsp;
    return canonical === 'subs' ? [] : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
  }
&nbsp;
  if (Platform.OS === 'android') {
    if (isInAppPurchase) {
...
&nbsp;
      const normalizedOffers = subscriptionOffers ?? <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
export const restorePurchases: MutationField&lt;'restorePurchases'&gt; = async () =&gt; {
  if (Platform.OS === 'ios') {
    await syncIOS().catch(<span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >undefined)</span>;
  }
&nbsp;
...
&nbsp;
  if (Platform.OS === 'android') {
    await deepLinkToSubscriptionsAndroid((options as DeepLinkOptions) ?? <span class="branch-1 cbranch-no" title="branch not covered" >null)</span>;
    return;
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      try {</span>
        ...
        const {default: Constants} = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >await import('</span>expo-constants');</span>
        const configApiKey = <span class="cstat-no" title="statement not covered" >Constants.expoConfig?.extra?.iapkitApiKey;</span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (configApiKey) {</span>
...
<span class="fstat-no" title="function not covered" >  ErrorCodeMapping,</span>
<span class="fstat-no" title="function not covered" >  createPurchaseError,</span>
<span class="fstat-no" title="function not covered" >  createPurchaseErrorFromPlatform,</span>
} from './utils/errorMapping';
export type {
  PurchaseError as ExpoPurchaseError,
  PurchaseErrorProps,
} from './utils/errorMapping';
export {<span class="fstat-no" title="function not covered" >ExpoIapConsole}</span> from './utils/debug';
&nbsp;</pre></td></tr></table></pre>
